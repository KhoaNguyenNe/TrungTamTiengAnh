...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($errors)) {
        ...
        $insert = "INSERT INTO `user` (email, password, name, phone, user_type, status) VALUES ('$email', '$password', '$name', '$phone', '$user_type', '$status')";
                        ...
                        <div class="email-call mail">
                            ...
                            <div class="social-media">
                                <div class="card">
                                    ...
                                    <a href="https://www.facebook.com/xuanchinhhuynh"
