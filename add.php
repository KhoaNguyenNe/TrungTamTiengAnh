...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($name)) {
        $errors['name'] = "Họ và tên bắt buộc phải nhập";
    }
    ...
    if (empty($errors)) {
        ...
        $insert = "INSERT INTO `user` (email, password, name, phone, user_type, status) VALUES ('$email', '$pass_hash', '$name', '$phone', '$user_type', '$status')";
    ...
    <form action="add.php" method="POST" class="user-form">
        <div class="form-row">
            <div class="form-column">
                ...
                <div class="error"><?= isset($errors['name']) ? $errors['name'] : '' ?></div><br><br>
                ...
                <label for="user_type">Loại người dùng:</label><br>
                <select id="user_type" name="user_type">
                    <option value="Admin" <?= isset($user_type) && $user_type == 'Admin' ? 'selected' : '' ?>>Admin
                    </option>
                    <option value="Người dùng" <?= isset($user_type) && $user_type == 'Người dùng' ? 'selected' : '' ?>>
                        Người dùng
                    </option>
                    <option value="Giảng viên" <?= isset($user_type) && $user_type == 'Giảng viên' ? 'selected' : '' ?>>
                        Giảng viên
                    </option>
                </select><br><br>
            ...
            <div class="form-column">
                ...
                <div class="error"><?= isset($errors['confirm_password']) ? $errors['confirm_password'] : '' ?>
                </div><br><br>
